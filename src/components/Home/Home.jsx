...
const Home = () => {
  return (
    <div>
      ...
      <h1>Tu libreria onlain, sin salir de casa.</h1>

        <section className='first-section'>
          <img src={pragueImg} alt="images" style={{ width: '400px', height: '300px' }}/>
        ...
        <img src={womanImg} alt="images" style={{ width: '400px', height: '300px' }}/>          <p>En nuestro catálogo encontrarás opciones para todas las edades y gustos, desde literatura infantil hasta novelas gráficas para adultos. También contamos con una amplia variedad de títulos en diferentes idiomas, por lo que si estás buscando algo en particular, ¡es probable que lo encuentres aquí!
          </p>
        </section>

        <section className='theerd-section'>
          <img src={fleaImg} alt="images" style={{ width: '400px', height: '300px' }}/>
        ...
        <section className='fourth-section'>
          <img src={booksImg} alt="images" style={{ width: '400px', height: '300px' }}/>
